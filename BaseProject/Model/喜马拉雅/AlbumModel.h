...
@class AlbumListAlbumModel,AlbumTracksModel,AlbumListModel;
@interface AlbumModel : BaseModel

@property (nonatomic, strong) AlbumTracksModel *tracks;

@property (nonatomic, strong) AlbumListAlbumModel *album;
...
@interface AlbumListAlbumModel : NSObject
...
@property (nonatomic, strong) NSArray<AlbumListModel *> *list;
