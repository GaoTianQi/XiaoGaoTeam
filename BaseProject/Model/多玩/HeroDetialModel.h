...
@interface HeroDetialModel : BaseModel

@property (nonatomic, copy) NSString *ratingAttack;

@property (nonatomic, strong) HeroDetailSkillModel *Braum_W;

@property (nonatomic, copy) NSString *identify;

@property (nonatomic, copy) NSString *healthLevel;

@property (nonatomic, strong) HeroDetailSkillModel *Braum_Q;
...
@property (nonatomic, strong) HeroDetailSkillModel *Braum_E;
...
@property (nonatomic, strong) HeroDetailSkillModel *Braum_B;
...
@property (nonatomic, strong) HeroDetailSkillModel *Braum_R;
...
@interface HeroDetailSkillModel : NSObject
